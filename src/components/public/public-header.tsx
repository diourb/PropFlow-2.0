    ...
    <header className="sticky top-0 z-40 border-b border-outline-variant/40 bg-surface/85 backdrop-blur-xl">
      <div className="mx-auto flex h-20 max-w-[1440px] items-center justify-between px-5 md:px-10">
        ...
        <div className="flex items-center gap-3">
          <Link
            className="hidden text-sm font-semibold text-primary transition hover:text-secondary md:inline-flex"
            href="/login"
          >
            Login
          </Link>
          <Link
            className="inline-flex h-11 items-center rounded-lg bg-primary-container px-5 text-sm font-semibold text-on-primary ambient-shadow transition hover:bg-primary"
            href="/workspace"
          >
            Get Started
          </Link>
      ...
      {menuOpen ? (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          />
          <div className="absolute right-0 top-0 flex h-full w-72 flex-col bg-surface p-6 shadow-xl">
            ...
            <nav className="flex flex-col gap-1">
              ...
              <Link
                className="rounded-lg px-4 py-3 text-sm font-semibold text-primary hover:bg-surface-container-low"
                href="/login"
                onClick={() => setMenuOpen(false)}
              >
                Login
              ...
              <Link
                className="mt-2 flex h-11 items-center justify-center rounded-lg bg-primary-container text-sm font-semibold text-on-primary"
                href="/workspace"
                onClick={() => setMenuOpen(false)}
              >
                Get Started
